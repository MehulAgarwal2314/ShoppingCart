...
// import { Asliproduct1 } from "./Asliproduct";
...
// const Navbar = ({itemCount}) => {
  ...
  return (
    ...
    >
      ...
      {/* <i className="fa badge fa-lg" value={8} onClick={handleClick}>&#xf07a;</i> */}
      <i className="fa badge fa-lg" onClick={handleClick} >&#xf07a;</i>
      {/* <span class="badge badge-dark" style={{marginLeft: "-15px"}}>{itemCount}</span> */}
